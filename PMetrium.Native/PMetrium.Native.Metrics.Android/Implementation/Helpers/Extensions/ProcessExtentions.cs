...
namespace PMetrium.Native.Metrics.Android.Implementation.Helpers.Extensions
{
    public static class ProcessExtensions
    {
        ...
        public static async Task<string> StartForDeviceAndGetOutput(this Process process, string device)
        {
            var errors = "";
